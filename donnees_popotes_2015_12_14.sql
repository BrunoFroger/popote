...
-- Export de données de la table popote.commentaires : ~3 rows (environ)
...
-- Export de données de la table popote.constituants : ~74 rows (environ)
...
-- Export de données de la table popote.ingredients : ~50 rows (environ)
...
-- Export de données de la table popote.membres : ~6 rows (environ)
...
INSERT IGNORE INTO `membres` (`id_membre`, `login`, `password`, `nom`, `prenom`, `email`, `type`) VALUES
	...
	(6, 'bfr2', 'bfr', 'Froger', 'Bruno', 'bruno.froger2@wanadoo.fr', 'user');
/*!40000 ALTER TABLE `membres` ENABLE KEYS */;

-- Export de données de la table popote.photos : ~6 rows (environ)
...
INSERT IGNORE INTO `recettes` (`id_recette`, `id_membre`, `titre`, `nb_pers`, `cat_prix`, `cat_diff`, `note`, `nb_votes`, `description`, `preparation`, `cuisson`, `conseil`, `id_cat`, `id_ss_cat`) VALUES
	...
	(13, 2, 'Velouté de carottes au cumin', 6, 'Bon marché', 'Très Facile', 0, 0, 'Emincez l\'oignon. Faites fondre le beurre dans une cocotte minute, puis ajoutez l\'oignon. Faites dorer.\r\nAjoutez les carottes et la pomme de terre préalablement coupés en morceaux. Faites cuire ainsi 5 minutes.\r\nAjoutez l\'eau, ainsi que le curry et le cumin.\r\nFermez la cocotte et faire cuire 20 minutes après la montée en pression.\r\nIl ne reste plus qu\'à mixer le tout en y ajoutant la crème liquide... et bien sûr qu\'à se régaler!', '10 minutes', '25 minutes', 'Une entrée simple et bon marché, qui sera très appréciée de vos convives.', 4, 1);
