            ...
            <link rel="stylesheet" type="text/css" href="css/contenu.css" media="all">
                ...
                <body>
                    ...
                    <div id="global">
                        ...
                        <div id='commentaire'>
                            <div id='zonecomment'>
                                <p> Mes commentaires & notes perso sur les recettes du site
                                    hgfjshgkjqhdsflkjhdsljhf
                                    ksqhfdhqdskjfhdskjhfkjdshf
                                    ksqjhkjfdhqkjdshfkjdhsfkjshdf
                                    kjqhkjhsfkljhdskjfhdskjfhdskjhflkdsjhgf

                                </p>
                            </div><!-- fin zonecomment -->
                            <div id='modifcomment'>
                                <form method='POST' action='controleurs/accueil/check_commentaire.php?recette=$recette->id_recette'>
                                    <button type='submit' formmethod='post' onclick='controleurs / accueil / check_commentaire.php'>Modifier mes commentaires</button>
                                </form>
