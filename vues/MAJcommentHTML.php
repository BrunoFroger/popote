            ...
            <link rel="stylesheet" type="text/css" href="css/contenu.css" media="all">
                ...
                <body>
                    ...
                    <div id="global">
                        ...
                        <!-- ---------------------- saisie commentaire si membre connecté------------ -->
                        <div id='commentaire'>
                            
                            <div id='addcomment'>
                              <label>Mes commentaires sur cette recette</label>  
                              <textarea  id='commentajout' cols='80'form='formaddcomment' >
                                       (variable d'affichage du texte)
                                </textarea>
                            </div><!-- fin zonesaiiecomment --> 
                            <form id='formaddcomment' action='MAJcommentaire.php'>  
                                <div id='savecomment'> 
                                    <input type='submit' value='MAJ des commentaires'>
                                </div>  
                            </form>

                        </div>    
                        <!-- ---------------------- fin saisie commentaire si membre connecté-------- --> 
