...
INSERT IGNORE INTO `recettes` (`id_recette`, `id_membre`, `titre`, `nb_pers`, `cat_prix`, `cat_diff`, `note`, `somme_notes`, `nb_votes`, `description`, `preparation`, `cuisson`, `conseil`, `id_cat`, `id_ss_cat`, `publication`) VALUES
...
INSERT IGNORE INTO `preferees` (`id_preferee`, `id_recette`, `id_membre`) VALUES
	(1, 2, 2),
	(2, 10, 2),
	(3, 10, 2),
	(6, 5, 1),
