...
-- Export de la structure de la base pour popote
CREATE DATABASE IF NOT EXISTS `popote` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `popote`;

-- Export de données de la table popote.membres : ~7 rows (environ)
...
INSERT INTO `membres` (`id_membre`, `login`, `password`, `nom`, `prenom`, `email`, `type`) VALUES
	...
	(2, 'hlq', 'mdphlq', 'Le Queau', 'Helene', 'helene.lequeau@orange.com', 'admin'),
	...
	(10, 'bfr2', 'bfr2', 'Bruno', 'Froger', 'bruno.froger2@wanadoo.fr', 'user'),
	(11, '_popote', 'lmdpdp', 'popote', 'user par defaut', '', 'admin');
/*!40000 ALTER TABLE `membres` ENABLE KEYS */;

-- Export de données de la table popote.categorie : ~5 rows (environ)
...
-- Export de données de la table popote.ingredients : ~52 rows (environ)
...
INSERT INTO `ingredients` (`id_ingredient`, `nom`, `couleur`, `type`) VALUES
	...
	(51, 'Poulet', 'blanc', 'viande'),
	(52, '', '', '');
/*!40000 ALTER TABLE `ingredients` ENABLE KEYS */;
-- Export de données de la table popote.sous_categorie : ~4 rows (environ)
...
-- Export de données de la table popote.recettes : ~15 rows (environ)
/*!40000 ALTER TABLE `recettes` DISABLE KEYS */;
INSERT INTO `recettes` (`id_recette`, `id_membre`, `titre`, `nb_pers`, `cat_prix`, `cat_diff`, `note`, `somme_notes`, `nb_votes`, `description`, `preparation`, `cuisson`, `conseil`, `id_cat`, `id_ss_cat`, `publication`) VALUES
	(1, 3, 'soupe', 4, 'Gratuit (0/5)', 'Super débutant (0/5)', 0, 0, 0, 'cuire les legumes, mouliner, servir', '10mn', '20mn', 'ajouter de la creme au moment de servir', 4, 1, 1),
	(2, 2, 'carottes rapées', 4, 'Gratuit (0/5)', 'Super débutant (0/5)', 0, 0, 0, 'eplucher et raper les carottes, assaisonner avec une vinaigrette', '15mn', '0mn', 'ajouter du jus d\'orange', 4, 1, 1),
	(4, 1, 'Cake au yaourt glacé au chocolat noir', 4, 'Très Abordable (2/5)', 'Débutant expérimenté (2/5)', 3, 0, 7, 'Préchauffez le four à 180°C (thermostat 6).\r\nDans un saladier, versez le yaourt nature, cassez les oeufs et mélangez. Ajoutez le sucre et mélangez. Incorporez ensuite la farine et fouettez de nouveau.\r\nMettez la moitié du zeste de l\'orange, l\'extrait de vanille et mélangez. Terminez par la levure et l\'huile et mélangez bien pour obtenir une pâte bien lisse.\r\nBeurrez un moule à cake et versez-y la pâte à gâteau. Enfournez pour 30 minutes de cuisson.\r\nLorsque le cake est cuit, laissez-le reposez quelques minutes puis démoulez-le. Laissez le cake refroidir complètement.\r\nChemisez l\'intérieur d\'un tube en plastique ou en aluminium de papier cuisson et placez-le au congélateur 10 minutes. Remplissez ensuite l\'intérieur de crème glacée Carte d\'Or au chocolat noir et remettez-le au congélateur jusqu\'au moment de servir.\r\nQuand vous vous apprêtez à servir le dessert, coupez les extrémités du cake et évidez le centre. Insérez le tube de glace au chocolat noir préalablement démoulé. Servez.', '30 minutes', '30 minutes', '', 3, 1, 0),
	(5, 10, 'Filet mignon en croûte', 6, 'Gratuit (0/5)', 'Super débutant (0/5)', 3, 0, 8, 'Emincer les oignons et les faire revenir dans une sauteuse avec du beurre. Les retirer, et faire revenir la viande de chaque côté, laisser cuire 10 mn à feu doux et ajouter les oignons pendant 5 mn. Saler, poivrer. Réserver.\r\nDérouler les pâtes feuilletées. Dépoer sur chaque pâte deux tranches de jambon et 100 g de gruyère. Saler et poivrer.\r\nY déposer un filet dans chaque pâte, ainsi que sa sauce aux oignons. Replier la pâte autour de la viande et fermer à l\'aide du jaune d’œuf et d\'un pinceau.\r\nCuire 45 mn sur 200°C.', '15 minutes', '45 minutes', 'Servir avec une salade.', 2, 2, 1),
	(6, 5, 'Mousse au chocolat facile', 4, 'Très Abordable (2/5)', 'Débutant expérimenté (2/5)', 0, 0, 0, 'Faire ramollir le chocolat dans une terrine.\r\nIncorporer les jaunes et le sucre.\r\nPuis, battre les blancs en neige ferme et les ajouter délicatement au mélange à l\'aide d\'une spatule.\r\nMettre au frais 1 heure ou 2 minimum.', '10 minutes', '', 'Vous pouvez utiliser n\'importe quel chocolat, Plus il sera noir, plus la mousse sera consistante.', 3, 1, 1),
	(8, 2, 'Gâteau au yaourt', 4, 'Gratuit (0/5)', 'Super débutant (0/5)', 0, 0, 0, 'Mélanger tout simplement les ingrédients un à un, dans l\'ordre ci-dessus.\r\nVerser la pâte dans un moule à gâteau.\r\nPuis, faire cuire à 180°C (thermostat 6) pendant 30 min environ.\r\nVérifier la cuisson avec la pointe d\'un couteau, qui doit ressortir sèche.', '15 minutes', '30 minutes', 'Vous pouvez remplacer le citron par un paquet de sucre vanillé. Comme yaourt je vous conseille des Veloutés ou autres yaourts liquides (bulgares, etc.).', 3, 1, 1),
	(9, 2, 'Tarte thon et tomate', 6, 'Très Abordable (2/5)', 'Débutant expérimenté (2/5)', 3, 0, 1, 'Etaler la pâte brisée et la piquer avec une fourchette.\r\nEmietter le thon sur la pâte.\r\nMélanger dans un gros bol : la crème, le concentré de tomate, l\'oeuf et le sel; verser la préparation sur le thon.\r\nSaupoudrer d\'herbes de Provence, recouvrir de fromage râpé, puis faire cuire comme une quiche, soit 25 min (selon puissance du four) à 210°C (th 7).', '10 minutes', '25 minutes', 'Hyper rapide, pour ceux qui aiment bien cuisiner sans y passer beaucoup de temps. Vous pouvez remplacer la pâte brisée par de la pâte feuilletée.', 2, 3, 1),
	(10, 4, 'La vraie Tartiflette', 4, 'Peu Cher (1/5)', 'Débutant (1/5)', 4, 0, 1, 'Éplucher les pommes de terre, les couper en dés, bien les rincer, et les essuyer dans un torchon propre.\r\nFaire chauffer l\'huile dans une poêle, pour y faire fondre les oignons; rajouter ensuite les pommes de terre.\r\nFaire dorer tous les côtés des dés de pommes de terre, rajouter les lardons, et finir de cuire.\r\nD\'autre part, gratter la croûte du reblochon et le couper en deux (ou en quatre). Préparer un plat à gratin en frottant le fond et les bords avec de l\'ail.\r\nPréchauffer le four à 200°C (thermostat 6-7).\r\nDans le plat à gratin, verser une couche de pommes de terre aux lardons, disposer dessus la moitié du reblochon, puis de nouveau des pommes de terre.\r\nTerminer avec le reste du reblochon (croûte vers les pommes de terre), et enfourner pendant environ 20 min.\r\nBien surveiller, pour éviter que le fromage ne rende trop de gras.', '15 minutes', '60 minutes', 'Vin de Savoie type Apremont ou Vin de Seyssel', 2, 1, 1),
	(11, 2, 'Papillote de saumon à la mozzarella', 2, 'Gratuit (0/5)', 'Super débutant (0/5)', 4, 0, 1, 'Mettre chaque pavé de saumon sur 1 feuille d\'aluminium séparé.\r\nCouper les tomates et la mozzarella en fines tranches.\r\nSaler et poivrer légèrement le saumon.\r\nDisposer sur chaque saumon en alternance : 1 tranche de tomate, puis 1 tranche de mozzarella, puis 1 tranche de tomate, etc.\r\nEmincer les olives et les gousses d\'ail, en saupoudrer les 2 pavés de saumon; ajouter un peu de sel, poivre, et saupoudrer d\'herbes.\r\nVerser sur chaque pavé de saumon l\'équivalent de 2 cuillères à café d\'huile d\'olive.\r\nRefermer chaque aluminium en papillote, et les disposer dans un plat à gratin.\r\nMettre à four chaud (210°C/th 7) pendant 35 min, le saumon est cuit lorque sa peau s\'est bien éclaircie.\r\nServir avec du riz basmati parfumé et une salade verte (dans laquelle vous aurez rajouté un peu d\'oignon).', '15 minutes', '35 minutes', 'C\'est une recette très facile mais très goûteuse, je l\'ai faite très souvent en été avec une bonne salade et tout le monde se régale', 2, 3, 1),
	(12, 1, 'Les Timbales de Jeanne (saumon à la mousse de courgette)', 4, 'Très Abordable (2/5)', 'Expert débutant (3/5)', 2, 125, 75, 'Râper les courgettes.\r\nLes faire revenir dans de l\'huile d\'olive avec l\'ail et les herbes. Poivrer, et saler (mais pas trop, attention au saumon fumé !). Réserver, et laisser un peu refroidir.\r\nBattre les oeufs et la crème en omelette.\r\nMélanger l\'omelette avec les courgettes, éventuellement, donner un petit coup de mixeur pour le côté "mousse".\r\nTapisser 4 ramequins avec les tranches de saumon fumé.\r\nVerser le mélange omelette-courgettes dans les ramequins tapissés de saumon.\r\nFaire cuire au micro-ondes pendant 2 à 3 min, selon la puissance (vérifier la cuisson vous même, il n\'y a que ça de vrai !)', '10 minutes', '3 minutes', 'Facile à faire... pour un résultat assez "pro". Bien sûr, les puristes peuvent cuire le tout au four, au bain-marie. Dernière remarque : vous pouvez y aller, c\'est tout à fait diététique (à condition d\'y aller molo sur l\'huile d\'olive, et de choisir ', 4, 3, 0),
	(13, 2, 'Velouté de carottes au cumin', 6, 'Gratuit (0/5)', 'Super débutant (0/5)', 2, 0, 26, 'Emincez l\'oignon. Faites fondre le beurre dans une cocotte minute, puis ajoutez l\'oignon. Faites dorer.\r\nAjoutez les carottes et la pomme de terre préalablement coupés en morceaux. Faites cuire ainsi 5 minutes.\r\nAjoutez l\'eau, ainsi que le curry et le cumin.\r\nFermez la cocotte et faire cuire 20 minutes après la montée en pression.\r\nIl ne reste plus qu\'à mixer le tout en y ajoutant la crème liquide... et bien sûr qu\'à se régaler!', '10 minutes', '25 minutes', 'Une entrée simple et bon marché, qui sera très appréciée de vos convives.', 4, 1, 0),
	(16, 1, 'poulet roti ', 4, 'Gratuit (0/5)', 'Super débutant (0/5)', 0, 0, 0, 'mettre le poulet dans un plat, mettre un peu d\'eau au fond du plat avec un bouillon cube', '10 minutes', '1 heure', 'retourner en milieu de cuisson', 2, 2, 1),
	(17, 10, 'poulet au four', 1, 'Gratuit (0/5)', 'Super débutant (0/5)', 0, 0, 0, 'd', 'f', 'e', 'g', 2, 2, 1),
	(18, 2, 'Tarte à la moutarde', 0, '', '', 0, 0, 0, '', '', '', '', 6, 1, 0),
	(19, 2, 'Tartine fromage ', 1, 'Gratuit (0/5)', 'Super débutant (0/5)', 0, 0, 0, '', '', '', '', 2, 1, 0);
/*!40000 ALTER TABLE `recettes` ENABLE KEYS */;

-- Export de données de la table popote.commentaires : ~8 rows (environ)
/*!40000 ALTER TABLE `commentaires` DISABLE KEYS */;
INSERT INTO `commentaires` (`id_commentaire`, `id_recette`, `id_membre`, `message`) VALUES
	(1, 1, 1, 'commentaire du Bruno sur la soupe '),
	(2, 6, 2, 'commentaire sur la mousse au chocolat par Hélène'),
	(3, 6, 1, 'commentaire du Bruno sur la mousse au chocolat modifie'),
	(11, 10, 1, 'commentaire de bruno pour la tartiflette'),
	(12, 4, 2, 'hgjhgjhg'),
	(13, 9, 2, ':;mlkmlkml'),
	(14, 2, 1, 'commentaire carottes rapees bruno'),
	(15, 11, 3, 'commentaires papillote');
/*!40000 ALTER TABLE `commentaires` ENABLE KEYS */;

-- Export de données de la table popote.constituants : ~75 rows (environ)
...
-- Export de données de la table popote.photos : ~13 rows (environ)
/*!40000 ALTER TABLE `photos` DISABLE KEYS */;
INSERT INTO `photos` (`id_photo`, `id_recette`, `lien`) VALUES
	(1, 1, 'bte_soupe.jpg'),
	(2, 2, 'hlq_carottes_rapees.jpg'),
	(3, 4, 'bfr_cake_yaourt_chocolot.jpg'),
	(4, 5, 'bfr2_filet_mignon_croute.jpg'),
	(6, 8, 'hlq_gateau_yaourt.jpg'),
	(7, 11, 'bfr_papillotte_saumon_mozarella.jpg'),
	(9, 13, 'hlq_veloute_carotte_cumin.jpg'),
	(10, 10, 'bfr_tartiflette.jpg'),
	(11, 12, 'bfr_saumon_mousse_courgette.jpg'),
	(12, 9, 'bfr_tarte_thon_tomate.jpg'),
	(13, 6, 'bfr_mousse_au_chocolat.jpg'),
	(14, 16, 'bfr_poulet_roti.jpg'),
	(15, 17, 'bfr_poulet_roti.jpg');
/*!40000 ALTER TABLE `photos` ENABLE KEYS */;

-- Export de données de la table popote.preferees : ~8 rows (environ)
/*!40000 ALTER TABLE `preferees` DISABLE KEYS */;
INSERT INTO `preferees` (`id_preferee`, `id_recette`, `id_membre`) VALUES
	(1, 2, 2),
	(2, 10, 2),
	(3, 10, 2),
	(6, 5, 1),
