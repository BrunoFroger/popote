...
-- -----------------------------------------------------
-- Placeholder table for view `popote`.`categories_par_recette`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `popote`.`categories_par_recette` (`titre` INT, `nom` INT);
...
-- -----------------------------------------------------
-- View `popote`.`categories_par_recette`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `popote`.`categories_par_recette` ;
DROP TABLE IF EXISTS `popote`.`categories_par_recette`;
USE `popote`;
CREATE  OR REPLACE VIEW `categories_par_recette` AS
