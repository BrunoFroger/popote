...
if ($changeMembre->type =='admin'){
    $changeMembre->type='user';
}else{
    $changeMembre->type='admin';    
}
$changeMembre->update($changeMembre->id_membre, $changeMembre->login, $changeMembre->password, $changeMembre->nom, $changeMembre->prenom, $changeMembre->email, $changeMembre->type);
